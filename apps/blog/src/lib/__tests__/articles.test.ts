...
const sampleTags: Tag[] = [
  { id: "tag-1", name: "javascript", slug: "javascript", createdAt: "2024-01-01T00:00:00Z" },
  { id: "tag-2", name: "typescript", slug: "typescript", createdAt: "2024-01-01T00:00:00Z" },
  { id: "tag-3", name: "testing", slug: "testing", createdAt: "2024-01-01T00:00:00Z" },
];
...
describe("articles", () => {
  ...
  describe("getArticlesByTag", () => {
    it("should fetch articles filtered by tag", async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        expect.stringContaining("/articles?status=published&tag=javascript&perPage=1000"),
        expect.any(Object)
      );
