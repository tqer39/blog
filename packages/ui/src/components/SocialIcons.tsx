/**
 * Social media icons for use across the blog
 * These are custom SVG icons for platforms not available in lucide-react
 *
 * For GitHub, LinkedIn, LayoutGrid (Bento), and Rss icons, use lucide-react directly.
 */
...
// Wantedly icon
export function WantedlyIcon({ className }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
// Lapras icon
export function LaprasIcon({ className }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
export function HatenaIcon({ className }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
// TechFeed icon
export function TechFeedIcon({ className }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
